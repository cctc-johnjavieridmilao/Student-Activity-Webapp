      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" style="display: none;" id="approved">Approved</button>
            <button type="button" class="btn btn-primary" style="display: none;" id="dis_approved">Disaaproved</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
          ...
          <form class="pt-3">
                ...
                <div class="form-group">
                <select class="form-control form-control-lg cuserinput" id="cdepartment">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg cuserinput" id="cstudentid" placeholder="StudentID">
                </div>
   ...
   $(function() {
      GetUsersData();
       ...
       $.get('<?= base_url('Admin/GetDepartment') ?>',(result) => {
            result.forEach((row) => {
              $('#cdepartment').append(`<option value="${row.DeptID}">${row.DeptName}</option>`);
            });
      },'json');
